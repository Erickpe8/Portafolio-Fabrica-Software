    ...
    <div class="py-16 bg-white dark:bg-gray-900 transition-colors">
        ...
        <div class="org-chart relative max-w-5xl mx-auto">
            ...
            <div
                ...
                role="button"
                :aria-label="'Abrir perfil de ' + teamMembersById.lider.name"
            >
            ...
            <!-- Miembros del equipo (Michelt y Yeison) -->
            ...
            <div
                ...
                @click="openTeamMemberModal('michelt')"
                role="button"
                aria-label="Abrir perfil de Michelt Alexandra Sánchez"
            >
            ...
            <div
                class="org-chart-node bg-white dark:bg-gray-800 rounded-2xl shadow p-4 text-center cursor-pointer transition-all hover:shadow-xl"
                @click="openTeamMemberModal('yeison')"
                role="button"
                aria-label="Abrir perfil de Yeison Edward Rolón Ortiz"
            >
                <div class="w-20 h-20 mx-auto mb-3 rounded-full overflow-hidden">
                <img
                    src="@/assets/img/team_2/Yeison_edward_rolon_ortiz.jpg"
                    alt="Yeison Edward Rolón Ortiz"
                    class="w-full h-full object-cover object-top"
                >
                </div>
...
const teamMembersById = ref({
    ...
    michelt: {
        ...
        projects: [{ name: 'Plataforma de evaluación a proveedores', url: '#' }]
    },
    ...
    yeison: {
        ...
        projects: [{ name: 'Módulos de matrículas', url: '#' }]
    }
})
